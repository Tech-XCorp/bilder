...
completevars="PYTHON MIXED_PYTHON PYTHON_SITEPKGSDIR NATIVE_PYTHON_SITEPKGSDIR PYTHONPATH PYTHON_BLDRVERSION PYTHON_MAJMIN PYTHON_DIR PYTHON_INCDIR PYTHON_TOPLIBDIR PYTHON_LIBDIR PYTHON_LIBSUBDIR PYTHON_LIB PYTHON_LLIB PYTHON_SHLIB PYTHON_LIB_LIBDIR"
