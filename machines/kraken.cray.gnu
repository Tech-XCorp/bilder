...
# SYSTEM_BLAS_PYC_LIB=${SYSTEM_BLAS_PYC_LIB:-""}
...
# SYSTEM_LAPACK_PYC_LIB=${SYSTEM_LAPACK_PYC_LIB:-""}
...
NIMROD_PAR_OTHER_ARGS=${NIMROD_PAR_OTHER_ARGS:-"SUPERLU_DIST_LIBS='-L/usr/common/acts/SuperLU/SuperLU_DIST_2.3/cray-xt4_O/lib -lsuperlu_dist_2.3 -L/usr/common/usg/parmetis/3.1 -lparmetis -lmetis'"}
...
VORPAL_PAR_OTHER_ARGS=${VORPAL_PAR_OTHER_ARGS:-"-DCMAKE_EXE_LINKER_FLAGS:STRING='-Wl,-static' -DUSE_STATIC_SYSLIBS:BOOL=TRUE -DDISABLE_UNIT_TESTS:BOOL=TRUE"}
VORPAL_SER_OTHER_ARGS=${VORPAL_SER_OTHER_ARGS:-"-DDISABLE_UNIT_TESTS:BOOL=TRUE"}
