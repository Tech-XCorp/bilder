...
# Here we should pick the flags, depending on CMAKE_BUILD_TYPE
    case $CMAKE_BUILD_TYPE in
      RELEASE | Release)
        CMAKE_NODEFLIB_FLAGS="$CMAKE_NODEFLIB_FLAGS_RELEASE"
        ;;
      RELWITHDEBINFO | RelWithDebInfo)
        CMAKE_NODEFLIB_FLAGS="$CMAKE_NODEFLIB_FLAGS_RELWITHDEBINFO"
        ;;
    esac
    ;;
...
cmakevars="PREFER_CMAKE USE_CMAKE_ARG CMAKE_LIBRARY_PATH_ARG CMAKE_NODEFLIB_FLAGS_RELEASE CMAKE_NODEFLIB_FLAGS_RELWITHDEBINFO CMAKE_NODEFLIB_FLAGS BOOST_INCDIR_ARG"
