...
# Force full link path
  TXBASE_SER_OTHER_ARGS="${TXBASE_SER_OTHER_ARGS} -DBUILD_SHARED=FALSE -DCMAKE_STATIC_LINKER_FLAGS:STRING='/NODEFAULTLIB:msvcrt' -DCMAKE_EXE_LINKER_FLAGS:STRING='/NODEFAULTLIB:msvcrt'"
