...
# All builds
  ...
  if bilderConfig -c txbase pycsh "-DBUILD_WITH_SHARED_RUNTIME:BOOL=TRUE $CMAKE_COMPILERS_PYC $CMAKE_COMPFLAGS_PYC $CMAKE_HDF5_PYCSH_DIR_ARG $CMAKE_SUPRA_SP_ARG $TXBASE_ADDL_ARGS $TXBASE_PYCSH_OTHER_ARGS"; then
