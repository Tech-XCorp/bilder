...
# dependents link to this for installation to work without DYLD_LIBRARY_PATH
    ...
    Linux)
      ...
      HDF5_PYCSH_ADDL_ARGS="-DCMAKE_SHARED_LINKER_FLAGS:STRING='-Wl,-rpath,\$ORIGIN' -DCMAKE_SKIP_RPATH:BOOL=ON $HDF5_PYCSH_ADDL_ARGS -DCMAKE_INSTALL_RPATH_USE_LINK_PATH:BOOL=TRUE"
      ;;
  esac
