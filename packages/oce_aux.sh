...
setOceTriggerVars() {
  ...
  OCE_REPO_BRANCH_STD=${OCE_REPO_BRANCH_STD:-"OCE-0.15"}
  # OCE_REPO_BRANCH_EXP=${OCE_REPO_BRANCH_EXP:-"OCE-0.16.1-txc"}
  # OCE_REPO_BRANCH_EXP=${OCE_REPO_BRANCH_EXP:-"OCE-0.17-clangfix"}
  OCE_REPO_BRANCH_EXP=${OCE_REPO_BRANCH_EXP:-"OCE-0.17-txc"}
