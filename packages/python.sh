...
# 2.7.13
      PYTHON_PYCSH_ADDL_ARGS="$PYTHON_PYCSH_ADDL_ARGS -DBUILD_SHARED=ON -DBUILD_LIBPYTHON_SHARED:BOOL=ON -DINSTALL_WINDOWS_TRADITIONAL=ON -DPYTHON_VERSION=$PY_DL_VERSION"
