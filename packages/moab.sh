...
# MOAB uses root dirs for dirs.
    if echo "$MOAB_BUILD_SET" | grep -q "full"; then
      MOAB_SER_CONFIG_ARGS="$MOAB_SER_CONFIG_ARGS -DENABLE_IMESH:BOOL=TRUE -DENABLE_IGEOM:BOOL=TRUE  -DENABLE_BOOST=TRUE -DBOOST_ROOT=$BOOST_SER_DIR -DENABLE_HDF5:BOOL=TRUE -DHDF5_ROOT:PATH='$HDF5_SER_DIR' -DENABLE_NETCDF:BOOL=TRUE -DNETCDF_ROOT='$NETCDF_SER_DIR' -DENABLE_DAGMC:BOOL=ON -DENABLE_CGM:BOOL=ON -DCGM_CFG='$CMAKE_CGM_PYCSH_DIR/lib/cgm.make' $OCE_SER_CMAKE_DIR_ARG"
      MOAB_PYCST_CONFIG_ARGS="$MOAB_PYCST_CONFIG_ARGS -DENABLE_IMESH:BOOL=TRUE -DENABLE_IGEOM:BOOL=TRUE -DENABLE_BOOST=TRUE -DBOOST_ROOT=$BOOST_SER_DIR -DENABLE_HDF5:BOOL=TRUE -DHDF5_ROOT:PATH='$HDF5_PYCST_DIR' -DENABLE_DAGMC:BOOL=ON -DENABLE_CGM:BOOL=ON -DCGM_CFG='$CMAKE_CGM_PYCSH_DIR/lib/cgm.make' $OCE_PYCSH_CMAKE_DIR_ARG"
      MOAB_PYCSH_CONFIG_ARGS="$MOAB_PYCSH_CONFIG_ARGS -DBUILD_SHARED_LIBS:BOOL=true -DENABLE_IMESH:BOOL=TRUE -DENABLE_IGEOM:BOOL=TRUE -DENABLE_BOOST=FALSE -DBOOST_ROOT=$BOOST_SER_DIR -DENABLE_HDF5:BOOL=TRUE -DHDF5_ROOT:PATH='$HDF5_PYCSH_DIR' -DENABLE_DAGMC:BOOL=ON -DENABLE_CGM:BOOL=ON -DCGM_CFG='$CGM_PYCSH_DIR/lib/cgm.make' $OCE_PYCSH_CMAKE_DIR_ARG"
      MOAB_PAR_CONFIG_ARGS="$MOAB_PAR_CONFIG_ARGS -DMPI_DIR:PATH='$CONTRIB_DIR/mpi' -DENABLE_IMESH:BOOL=TRUE -DENABLE_IGEOM:BOOL=TRUE -DENABLE_BOOST=TRUE -DBOOST_ROOT=$BOOST_SER_DIR -DENABLE_IMESH:BOOL=TRUE -DENABLE_HDF5:BOOL=TRUE -DHDF5_ROOT:PATH='$HDF5_PAR_DIR' -DENABLE_NETCDF:BOOL=TRUE -DNETCDF_ROOT='$NETCDF_SER_DIR' $MOAB_ZOLTAN_ARGS -DENABLE_DAGMC:BOOL=ON -DENABLE_CGM:BOOL=ON -DCGM_CFG='$CMAKE_CGM_PYCSH_DIR/lib/cgm.make' $OCE_SER_CMAKE_DIR_ARG"
    else
      MOAB_SER_CONFIG_ARGS="$MOAB_SER_CONFIG_ARGS -DENABLE_IMESH:BOOL=TRUE -DENABLE_BOOST=TRUE -DBOOST_ROOT=$BOOST_SER_DIR -DENABLE_HDF5:BOOL=TRUE -DHDF5_ROOT:PATH='$HDF5_SER_DIR' -DENABLE_NETCDF:BOOL=TRUE -DNETCDF_ROOT='$NETCDF_SER_DIR' -DENABLE_DAGMC:BOOL=OFF -DENABLE_CGM:BOOL=OFF"
      ...
      MOAB_PAR_CONFIG_ARGS="$MOAB_PAR_CONFIG_ARGS -DMPI_DIR:PATH='$CONTRIB_DIR/mpi' -DENABLE_BOOST=TRUE -DBOOST_ROOT=$BOOST_SER_DIR -DENABLE_IMESH:BOOL=TRUE -DENABLE_HDF5:BOOL=TRUE -DHDF5_ROOT:PATH='$HDF5_PAR_DIR' -DENABLE_NETCDF:BOOL=TRUE -DNETCDF_ROOT='$NETCDF_SER_DIR' -DPNETCDF_ROOT='$NETCDF_PAR_DIR' -DENABLE_DAGMC:BOOL=OFF -DENABLE_CGM:BOOL=OFF $MOAB_ZOLTAN_ARGS"
    fi
  else
