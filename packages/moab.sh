...
# par BUILD needed by ulixes
  ...
  if $MOAB_USE_CMAKE; then
    ...
    MOAB_PYSH_CONFIG_ARGS="-DBUILD_SHARED_LIBS:BOOL=TRUE -DCMAKE_INSTALL_NAME_DIR='${BLDR_INSTALL_DIR}/moab-${MOAB_BLDRVERSION}-${MOAB_BUILD}/lib' $CMAKE_COMPILERS_PYC $CMAKE_COMPFLAGS_PYC"
