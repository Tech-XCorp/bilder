...
# -DMOAB_BUILD_SET:STRING=lite: does not use CGM
    MOAB_PYCSH_CONFIG_ARGS="-DBUILD_SHARED_LIBS:BOOL=TRUE -DCMAKE_INSTALL_NAME_DIR='${BLDR_INSTALL_DIR}/moab-${MOAB_BLDRVERSION}-$FORPYTHON_SHARED_BUILD/lib' -DMOAB_BUILD_SET:STRING=lite $CMAKE_COMPILERS_PYC $CMAKE_COMPFLAGS_PYC"
