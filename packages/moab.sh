...
# OCE always brought in shared
    ...
    MOAB_PAR_CONFIG_ARGS="-DENABLE_PARALLEL:BOOL=TRUE ${MOAB_PAR_CONFIG_ARGS} ${MOAB_GENCONFIG_ARGS} -DHDF5_DIR:PATH='${HDF5_PAR_DIR}' -DNetCDF_DIR:PATH='${NETCDF_SER_DIR}' -DZoltan_DIR:PATH='${TRILINOS_PARCOMM_DIR}'"
  else
