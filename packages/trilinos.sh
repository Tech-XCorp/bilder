...
# SuperLU serial and parallal libraries have different names, and the comm superlu builds are without parmetis
  ...
  TRILINOS_SERCOMMSH_ADDL_ARGS="$TRILINOS_SERSH_ADDL_ARGS -DTPL_ENABLE_SuperLU:BOOL=ON -DSuperLU_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-sersh/include' -DSuperLU_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-sersh/lib' -DSuperLU_LIBRARY_NAMES:STRING='superlu' -DPYTHON_INCLUDE_DIR:PATH=$PYTHON_INCDIR -DPYTHON_LIBRARY:FILEPATH=$PYTHON_SHLIB"
  if $BUILD_EXPERIMENTAL; then
    TRILINOS_SERCOMMSH_ADDL_ARGS="$TRILINOS_SERSH_ADDL_ARGS -DTrilinos_ENABLE_PyTrilinos:STRING=ON"
  fi
  TRILINOS_PARCOMM_ADDL_ARGS="$TRILINOS_PAR_ADDL_ARGS -DTPL_ENABLE_SuperLUDist:BOOL=ON -DTPL_ENABLE_SuperLUDist_Without_ParMETIS:BOOL=TRUE -DSuperLUDist_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu_dist-${SUPERLU_DIST_BLDRVERSION}-parcomm/include' -DSuperLUDist_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu_dist-${SUPERLU_DIST_BLDRVERSION}-parcomm/lib' -DSuperLUDist_LIBRARY_NAMES:STRING='superlu_dist'"
  TRILINOS_PARCOMMSH_ADDL_ARGS="$TRILINOS_PARSH_ADDL_ARGS -DTPL_ENABLE_SuperLUDist:BOOL=ON -DTPL_ENABLE_SuperLUDist_Without_ParMETIS:BOOL=TRUE -DSuperLUDist_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu_dist-${SUPERLU_DIST_BLDRVERSION}-parcommsh/include' -DSuperLUDist_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu_dist-${SUPERLU_DIST_BLDRVERSION}-parcommsh/lib' -DSuperLUDist_LIBRARY_NAMES:STRING='superlu_dist'"
  TRILINOS_BEN_ADDL_ARGS="$TRILINOS_BEN_ADDL_ARGS -DTPL_ENABLE_SuperLUDist:BOOL=ON -DTPL_ENABLE_SuperLUDist_Without_ParMETIS:BOOL=TRUE -DSuperLU_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu_dist-${SUPERLU_DIST_BLDRVERSION}-ben/include' -DSuperLU_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu_dist-${SUPERLU_DIST_BLDRVERSION}-ben/lib' -DSuperLU_LIBRARY_NAMES:STRING='superlu_dist'"
# The builds
