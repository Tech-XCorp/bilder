...
# Add in the locations by build
  TRILINOS_SERCOMM_ADDL_ARGS="$TRILINOS_SER_ADDL_ARGS -DSuperLU_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ser/include' -DSuperLU_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ser/lib' -DSuperLU_LIBRARY_NAMES:STRING='superlu'"
  TRILINOS_SERCOMMSH_ADDL_ARGS="$TRILINOS_SERSH_ADDL_ARGS -DSuperLU_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ser/include' -DSuperLU_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ser/lib' -DSuperLU_LIBRARY_NAMES:STRING='superlu'"
  TRILINOS_PARCOMM_ADDL_ARGS="$TRILINOS_PAR_ADDL_ARGS -DSuperLU_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ser/include' -DSuperLU_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ser/lib' -DSuperLU_LIBRARY_NAMES:STRING='superlu'"
  TRILINOS_PARCOMMSH_ADDL_ARGS="$TRILINOS_PARSH_ADDL_ARGS -DSuperLU_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ser/include' -DSuperLU_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ser/lib' -DSuperLU_LIBRARY_NAMES:STRING='superlu'"
