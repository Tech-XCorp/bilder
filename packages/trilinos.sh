...
# Add in the locations by build
  ...
  TRILINOS_PARCOMM_ADDL_ARGS="$TRILINOS_PAR_ADDL_ARGS -DTPL_ENABLE_SuperLUDistDist:BOOL=ON -DSuperLUDist_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-par/include' -DSuperLUDist_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-par/lib' -DSuperLUDist_LIBRARY_NAMES:STRING='superlu'"
  TRILINOS_PARCOMMSH_ADDL_ARGS="$TRILINOS_PARSH_ADDL_ARGS -DTPL_ENABLE_SuperLUDistDist:BOOL=ON -DSuperLUDist_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}parsh/include' -DSuperLUDist_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}parsh/lib' -DSuperLUDist_LIBRARY_NAMES:STRING='superlu'"
  TRILINOS_BEN_ADDL_ARGS="$TRILINOS_PAR_ADDL_ARGS -DSuperLU_INCLUDE_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ben/include' -DSuperLU_LIBRARY_DIRS:PATH='$CONTRIB_DIR/superlu-${SUPERLU_BLDRVERSION}-ben/lib' -DSuperLU_LIBRARY_NAMES:STRING='superlu'"
# The builds
