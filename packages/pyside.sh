...
# PYSIDE does not have all dependencies right, so needs nmake
  ...
  PYSIDE_ADDL_ARGS="-D$CONTRIB_DIR/shiboken-$SHIBOKEN_BLDRVERSION-ser/lib/cmake/Shiboken-$SHIBOKEN_BLDRVERSION -DCXXFLAGS='$CXXFLAGS -I$CONTRIB_DIR/qt-${QT_BLDRVERSION}-sersh/include"
