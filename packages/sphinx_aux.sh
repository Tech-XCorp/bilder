...
setSphinxTriggerVars() {
  ...
  SPHINX_DEPS=alabaster,Babel,colorama,Jinja2,six,snowballstemmer,sphinx_bootstrap_theme,sphinx_rtd_theme,typing,docutils,Pygments,Imaging,MathJax,setuptools,Python
}
setSphinxTriggerVars
